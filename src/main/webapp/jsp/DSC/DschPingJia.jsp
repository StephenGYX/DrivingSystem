	...
	layui.use(['form', 'table'], function () {
		...
		table.render({
			...
			cols: [[
				...
				{field: 'cid', width: 60, title: '学员id', sort: true},
				// {field: 'caccount', width: 80, title: '账号', sort: true},
				{
					field: 'caccount', width: 120, title: '账号', sort: true
					, templet: function (d) {
						return d.consumer[0].caccount;
					}
				},
				{
					field: 'cname', width: 80, title: '学员姓名',
					templet: function (d) {
						return d.consumer[0].cname;
					}
				},
				{field: 'edrivingscore', width: 100, title: '驾校评分', sort: true},
				{field: 'edrivingcontent', width: 100, title: '评价', sort: true},
