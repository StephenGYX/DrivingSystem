				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<input type="text" name="username" lay-verify="required" lay-reqtext="用户名不能为空"
						       placeholder="请输入用户名" value="默认" class="layui-input" id="username">
<%--						onfocus="this.blur()--%>
...
<%--						<tip>填写驾校账号信息，该账号具有唯一性。</tip>--%>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="dcontacts" lay-verify="required" lay-reqtext="联系人不能为空"
						       placeholder="请输入联系人姓名" value="" class="layui-input" id="dcontacts">
						<tip>填写驾校负责人真实姓名。</tip>
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="password" id="dpassword" name="password" lay-verify="required" placeholder="请输入驾校账号密码" value="" class="layui-input">
					</div>
				</div>
<%--				<div class="layui-form-item">--%>
...
<%--				</div>--%>
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="number" name="phone" lay-verify="required" lay-reqtext="手机不能为空" placeholder="请输入手机"
						       value="" class="layui-input" id="dphone">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">邮箱</label>
					<div class="layui-input-block">
						<input type="email" name="email" lay-verify="email" placeholder="请输入邮箱" value="" class="layui-input" id="demail">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">驾校名称</label>
					<div class="layui-input-block">
						<input type="text" id="dname" name="dname" placeholder="请输入驾校名称" value="" class="layui-input">
					</div>
				</div>
				...
				<div class="layui-form-item" id="area-picker">
					...
					<div class="layui-input-inline" style="width: 200px;">
						<select name="province" class="province-selector" data-value="福建省" lay-filter="province-1" id="dprovince">
							<option value="" >请选择省</option>
						</select>
					</div>
					<div class="layui-input-inline" style="width: 200px;">
						<select name="city" class="city-selector" data-value="" lay-filter="city-1" id="dcity">
							<option value="" >请选择市</option>
						</select>
					</div>
					<div class="layui-input-inline" style="width: 200px;">
						<select name="county" class="county-selector" data-value="" lay-filter="county-1" id="darea">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="number" name="cost" lay-verify="required" lay-reqtext="报名费用不能为空" placeholder="报名最低价"
						       value="" class="layui-input" id="dprice">
					</div>
				</div>
				...
				<div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-block">
						<textarea name="remark" class="layui-textarea" placeholder="请输入驾校简介" id="dsynopsis"></textarea>
					</div>
				</div>
				<div class="layui-form-item ">
