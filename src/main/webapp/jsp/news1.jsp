...
<head>
	<meta charset="utf-8">
	<title>${sessionScope.news.jtitle}</title>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-10 col-xs-12 article-detail">
				<c:if test="${sessionScope.news !=null}">
					<h1 class="article-detail-title">${sessionScope.news.jtitle}</h1>
					<div class="article-detail-date">
						发布日期：${sessionScope.news.jtime}
						&nbsp; 作者 ：${sessionScope.news.jauthor}
						&nbsp; 浏览量：${sessionScope.news.jliulan}
					</div>
				</c:if>

				<div class="article-detail-content fr-element fr-view">

					${sessionScope.news.jtext}
